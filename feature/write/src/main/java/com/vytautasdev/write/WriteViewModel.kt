...
import com.vytautasdev.ui.GalleryImage
import com.vytautasdev.ui.GalleryState
import com.vytautasdev.util.Constants.WRITE_SCREEN_ARGUMENT_KEY
...
import com.vytautasdev.util.toRealmInstant
    ...
    private fun fetchSelectedDiary() {
        if (uiState.selectedDiaryId != null) {
            viewModelScope.launch {
                MongoDB.getSelectedDiary(diaryId = ObjectId.from(uiState.selectedDiaryId!!)).catch {
                    ...
                    if (diary is RequestState.Success) {
                        ...
                        com.vytautasdev.util.fetchImagesFromFirebase(remoteImagePaths = diary.data.images,
